...
public class DbStoreService extends SQLiteOpenHelper implements StoreService {
    ...
    private static final String DATABASE_NAME = "beaconloc.db";
    ...
    public boolean createBeacon(TrackedBeacon beacon) {
        ...
        values.put(ScanColumns.COLUMN_URL, beacon.getEddyStoneBeaconURL());
    ...
    @Override
    public void updateBeaconDistance(String id, double distance) {
        final ContentValues values = new ContentValues();
    ...
    public List<ActionBeacon> getBeaconActions(String beaconId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                beacon.setIsEnabled(cursor.getInt(6) == 1);
                beacon.getNotification().setIsEnabled(cursor.getInt(7) == 1);
                beacon.getNotification().setIsVibrate(cursor.getInt(8) == 1);
    ...
    @Override
    public void deleteBeaconActions(String beaconId) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    static abstract class ScanColumns implements BaseColumns {
        static final String TABLE_NAME = "TrackedBeacon";
        static final String COLUMN_ID = "id";
        static final String COLUMN_BLUETOOTH_NAME = "bl_name";
        static final String COLUMN_BLUETOOTH_ADDRESS = "bl_address";
        static final String COLUMN_LAST_SEEN_TIME = "last_seen_time";
        static final String COLUMN_UUID = "uuid";
        static final String COLUMN_RSSI = "rssi";
        static final String COLUMN_TXPOWER = "tx";
    ...
    static abstract class ActionColumns implements BaseColumns {
        static final String TABLE_NAME = "ActionBeacon";
        static final String COLUMN_ID = "id";
        static final String COLUMN_BEACON_ID = "beacon_id";
        static final String COLUMN_NAME = "name";
        static final String COLUMN_EVENT_TYPE = "event_type";
        static final String COLUMN_ACTION_TYPE = "action_type";
        static final String COLUMN_ACTION_PARAMS = "action_param";
        static final String COLUMN_IS_ENABLED = "is_enabled";
        static final String COLUMN_NOTIF_IS_ENABLED = "notif_enabled";
        static final String COLUMN_NOTIF_VIBRATE_IS_ENABLED = "notif_vibrate";
        static final String COLUMN_NOTIF_RINGTONE = "notif_ringtone";
        static final String COLUMN_NOTIF_MSG = "notif_msg";
