...
public class BeaconViewModel extends BaseObservable {
    ...
    IManagedBeacon mManagedBeacon;
    BeaconFragment mFragment;

    BeaconViewModel(@NonNull BeaconFragment fragment, @NonNull IManagedBeacon managedBeacon) {
        this.mManagedBeacon = managedBeacon;
        this.mFragment = fragment;
    }

    public String getRssi() {
        return format("%d", mManagedBeacon.getRssi());
    }

    public String getTxPower() {
        return format("%d", mManagedBeacon.getTxPower());
    }
    ...
    public int getProximityColor() {
        if (isLostBeacon()) {
            return ContextCompat.getColor(mFragment.getActivity(), R.color.purdue_darker);
        }
    ...
    public String getUuid() {
        if (mManagedBeacon.getType() == DetectedBeacon.TYPE_EDDYSTONE_URL) {
            return mManagedBeacon.getEddyStoneBeaconURL();
        }
